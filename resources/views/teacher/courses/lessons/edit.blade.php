...
<div class="dashboard-container">
    ...
    <div class="page-header">
        <div>
            <h1 style="font-size: 2rem; color: #1f2937; margin-bottom: 5px;">تعديل الدرس</h1>
            <p style="color: #6b7280; margin: 0;">تحديث معلومات ومحتوى الدرس</p>
        </div>
        <div style="display: flex; gap: 15px;">
            <a href="{{ route('teacher.courses.lessons.show', [$course, $lesson]) }}" class="btn btn-outline">
    ...
    <div style="background: white; padding: 30px; border-radius: 15px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
        <form method="POST" action="{{ route('teacher.courses.lessons.update', [$course, $lesson]) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px;">
                ...
                <div>
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <input type="text" name="title_en" value="{{ old('title_en', $lesson->title_en) }}" required
                               style="width: 100%; padding: 12px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 1rem;">
                        @error('title_en')
                            <span style="color: #ef4444; font-size: 0.9rem;">{{ $message }}</span>
                        @enderror
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <input type="number" name="order" value="{{ old('order', $lesson->order) }}" min="1" required
                               style="width: 100%; padding: 12px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 1rem;">
                        @error('order')
                            <span style="color: #ef4444; font-size: 0.9rem;">{{ $message }}</span>
                        @enderror
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <input type="number" name="duration" value="{{ old('duration', $lesson->duration) }}" min="1" required
                               style="width: 100%; padding: 12px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 1rem;">
                        @error('duration')
                            <span style="color: #ef4444; font-size: 0.9rem;">{{ $message }}</span>
                        @enderror
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <select name="content_type" id="content_type" style="width: 100%; padding: 12px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 1rem;">
                            <option value="video" {{ old('content_type', $lesson->content_type) == 'video' ? 'selected' : '' }}>فيديو</option>
                            <option value="text" {{ old('content_type', $lesson->content_type) == 'text' ? 'selected' : '' }}>نص</option>
                            <option value="file" {{ old('content_type', $lesson->content_type) == 'file' ? 'selected' : '' }}>ملف</option>
                            <option value="link" {{ old('content_type', $lesson->content_type) == 'link' ? 'selected' : '' }}>رابط</option>
                        </select>
                        @error('content_type')
                            <span style="color: #ef4444; font-size: 0.9rem;">{{ $message }}</span>
                        @enderror
                ...
                <div>
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <textarea name="description_ar" rows="4" 
                                  style="width: 100%; padding: 12px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 1rem; resize: vertical;">{{ old('description_ar', $lesson->description_ar) }}</textarea>
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <textarea name="description_en" rows="4" 
                                  style="width: 100%; padding: 12px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 1rem; resize: vertical;">{{ old('description_en', $lesson->description_en) }}</textarea>
                    ...
                    <div id="content_fields">
                            ...
                            <div style="margin-bottom: 20px;">
                                ...
                                @if($lesson->video_file)
                                    <div style="margin-bottom: 10px;">
                                        <span style="color: #6b7280; font-size: 0.9rem;">الملف الحالي:</span>
                                        <a href="{{ asset('storage/' . $lesson->video_file) }}" target="_blank" style="color: #3b82f6; text-decoration: none;">
                        ...
                        <div id="text_content" class="content-field" style="display: none;">
                            <div style="margin-bottom: 20px;">
                                ...
                                <textarea name="text_content_ar" rows="6" 
                                          style="width: 100%; padding: 12px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 1rem; resize: vertical;">{{ old('text_content_ar', $lesson->text_content_ar) }}</textarea>
                            ...
                            <div style="margin-bottom: 20px;">
                                ...
                                <textarea name="text_content_en" rows="6" 
                                          style="width: 100%; padding: 12px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 1rem; resize: vertical;">{{ old('text_content_en', $lesson->text_content_en) }}</textarea>
                        ...
                        <div id="file_content" class="content-field" style="display: none;">
                            <div style="margin-bottom: 20px;">
                                ...
                                @if($lesson->lesson_file)
                                    <div style="margin-bottom: 10px;">
                                        <span style="color: #6b7280; font-size: 0.9rem;">الملف الحالي:</span>
                                        <a href="{{ asset('storage/' . $lesson->lesson_file) }}" target="_blank" style="color: #3b82f6; text-decoration: none;">
                                            {{ basename($lesson->lesson_file) }}
                                        </a>
                                    </div>
                                @endif
                        ...
                        <div id="link_content" class="content-field" style="display: none;">
                            <div style="margin-bottom: 20px;">
                                ...
                                <input type="url" name="lesson_link" value="{{ old('lesson_link', $lesson->lesson_link) }}" 
