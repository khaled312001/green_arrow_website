...
<head>
    ...
    <title>@yield('title', 'لوحة تحكم المدرب') - أكاديمية السهم الأخضر</title>
    ...
    <div class="teacher-container">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section">
                    <div class="nav-section-title">إدارة الدورات</div>
                    <a href="{{ route('teacher.courses.index') }}" class="nav-item {{ request()->routeIs('teacher.courses.*') ? 'active' : '' }}">
                        <i class="bi bi-book"></i>
                        دوراتي
                    </a>
                    <a href="{{ route('teacher.courses.create') }}" class="nav-item">
                ...
                <div class="nav-section">
                    <div class="nav-section-title">إدارة الطلاب</div>
                    <a href="{{ route('teacher.students.index') }}" class="nav-item {{ request()->routeIs('teacher.students.*') ? 'active' : '' }}">
                        <i class="bi bi-people"></i>
                        طلابي
                    </a>
                    <a href="{{ route('teacher.enrollments.index') }}" class="nav-item {{ request()->routeIs('teacher.enrollments.*') ? 'active' : '' }}">
                ...
                <div class="nav-section">
                    ...
                    <a href="{{ route('teacher.analytics.index') }}" class="nav-item {{ request()->routeIs('teacher.analytics.*') ? 'active' : '' }}">
        ...
        <main class="main-content">
            ...
            <div class="top-bar">
                <div style="display: flex; align-items: center; gap: 15px;">
                    ...
                    <h1 class="page-title">@yield('title', 'لوحة تحكم المدرب')</h1>
                </div>
