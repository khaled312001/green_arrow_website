<div class="setting-group">
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="site_name" name="settings[site][site_name]" 
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="site_description" name="settings[site][site_description]" 
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input type="email" class="form-control" id="site_email" name="settings[site][site_email]" 
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="site_phone" name="settings[site][site_phone]" 
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="site_whatsapp" name="settings[site][site_whatsapp]" 
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="site_address" name="settings[site][site_address]" 
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="site_working_hours" name="settings[site][site_working_hours]" 
