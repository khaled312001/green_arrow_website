CREATE TABLE `migrations` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `migration` varchar(255) not null, `batch` int(11) not null);
...
CREATE TABLE `jobs` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `queue` varchar(255) not null, `payload` longtext not null, `attempts` int(11) not null, `reserved_at` int(11), `available_at` int(11) not null, `created_at` int(11) not null);
...
CREATE TABLE `failed_jobs` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `uuid` varchar(255) not null, `connection` longtext not null, `queue` longtext not null, `payload` longtext not null, `exception` longtext not null, `failed_at` timestamp not null default CURRENT_TIMESTAMP);


CREATE TABLE `roles_and_permissions_tables` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `created_at` timestamp, `updated_at` timestamp);


CREATE TABLE `categories` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `name_ar` varchar(255) not null, `name_en` varchar(255), `slug` varchar(255) not null, `description_ar` longtext, `description_en` longtext, `icon` varchar(255), `color` varchar(255) not null default '#10B981', `image` varchar(255), `is_active` tinyint(1) not null default '1', `sort_order` int(11) not null default '0', `created_at` timestamp, `updated_at` timestamp);
...
CREATE TABLE `lessons` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `course_id` int(11) not null, `title_ar` varchar(255) not null, `title_en` varchar(255), `slug` varchar(255) not null, `description_ar` longtext, `description_en` longtext, `type` varchar(255) not null default 'video', `video_url` varchar(255), `video_duration` varchar(255), `pdf_file` varchar(255), `longtext_content` longtext, `attachments` longtext, `live_session_date` timestamp, `google_meet_link` varchar(255), `meeting_id` varchar(255), `meeting_password` varchar(255), `is_free` tinyint(1) not null default '0', `is_published` tinyint(1) not null default '1', `sort_order` int(11) not null default '0', `duration_minutes` int(11) not null default '0', `views_count` int(11) not null default '0', `completed_count` int(11) not null default '0', `created_at` timestamp, `updated_at` timestamp, foreign key(`course_id`) references `courses`(`id`) on delete cascade);
...
CREATE TABLE `enrollments` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `user_id` int(11) not null, `course_id` int(11) not null, `payment_id` int(11), `status` varchar(255) not null default 'pending', `enrolled_at` timestamp not null, `expires_at` timestamp, `completed_at` timestamp, `progress_percentage` int(11) not null default '0', `lessons_completed` int(11) not null default '0', `total_lessons` int(11) not null default '0', `quiz_attempts` int(11) not null default '0', `quiz_average` numeric, `live_sessions_attended` int(11) not null default '0', `total_live_sessions` int(11) not null default '0', `rating` int(11), `review` longtext, `reviewed_at` timestamp, `certificate_issued` tinyint(1) not null default '0', `certificate_issued_at` timestamp, `certificate_number` varchar(255), `last_accessed_at` timestamp, `last_lesson_id` int(11), `created_at` timestamp, `updated_at` timestamp, `total_hours_watched` numeric not null default '0', `activated_at` timestamp, foreign key(`user_id`) references `users`(`id`) on delete cascade, foreign key(`course_id`) references `courses`(`id`) on delete cascade, foreign key(`payment_id`) references `payments`(`id`) on delete set null, foreign key(`last_lesson_id`) references `lessons`(`id`) on delete set null);
...
CREATE TABLE `quizzes` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `course_id` int(11) not null, `lesson_id` int(11), `title_ar` varchar(255) not null, `title_en` varchar(255), `description_ar` longtext, `description_en` longtext, `duration_minutes` int(11) not null default '30', `passing_score` int(11) not null default '70', `is_active` tinyint(1) not null default '1', `allow_retake` tinyint(1) not null default '1', `max_attempts` int(11) not null default '3', `show_results` tinyint(1) not null default '1', `randomize_questions` tinyint(1) not null default '0', `due_date` timestamp, `total_questions` int(11) not null default '0', `total_points` int(11) not null default '0', `created_at` timestamp, `updated_at` timestamp, foreign key(`course_id`) references `courses`(`id`) on delete cascade, foreign key(`lesson_id`) references `lessons`(`id`) on delete cascade);
...
CREATE TABLE `certificates` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `user_id` int(11) not null, `course_id` int(11) not null, `enrollment_id` int(11) not null, `certificate_number` varchar(255) not null, `issued_at` timestamp, `pdf_path` varchar(255), `verification_code` varchar(255) not null, `is_verified` tinyint(1) not null default '0', `notes` longtext, `created_at` timestamp, `updated_at` timestamp, foreign key(`user_id`) references `users`(`id`) on delete cascade, foreign key(`course_id`) references `courses`(`id`) on delete cascade, foreign key(`enrollment_id`) references `enrollments`(`id`) on delete cascade);
...
CREATE TABLE `notifications` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `title` varchar(255) not null, `message` longtext not null, `type` varchar(255) not null default 'info', `user_id` int(11), `read_at` timestamp, `data` longtext, `created_at` timestamp, `updated_at` timestamp, foreign key(`user_id`) references `users`(`id`) on delete cascade);
...
CREATE TABLE `permissions` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `name` varchar(255) not null, `guard_name` varchar(255) not null, `created_at` timestamp, `updated_at` timestamp);
...
CREATE TABLE `roles` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `name` varchar(255) not null, `guard_name` varchar(255) not null, `created_at` timestamp, `updated_at` timestamp);
...
CREATE TABLE `settings` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `key` varchar(255) not null, `value` longtext, `type` varchar(255) not null default 'string', `group` varchar(255) not null default 'general', `label` varchar(255), `description` longtext, `is_public` tinyint(1) not null default '0', `created_at` timestamp, `updated_at` timestamp);
...
INSERT INTO `settings` (`id`, `key`, `value`, `type`, `group`, `label`, `description`, `is_public`, `created_at`, `updated_at`) VALUES ('16', 'course_approval_required', '1', 'tinyint(1)', 'courses', 'تتطلب الموافقة على الدورات', 'هل تتطلب الدورات موافقة قبل النشر', '0', '2025-08-25 12:56:25', '2025-08-25 12:56:25');
INSERT INTO `settings` (`id`, `key`, `value`, `type`, `group`, `label`, `description`, `is_public`, `created_at`, `updated_at`) VALUES ('17', 'allow_course_preview', '1', 'tinyint(1)', 'courses', 'السماح بمعاينة الدورات', 'السماح للمستخدمين بمعاينة الدورات', '0', '2025-08-25 12:56:25', '2025-08-25 12:56:25');
INSERT INTO `settings` (`id`, `key`, `value`, `type`, `group`, `label`, `description`, `is_public`, `created_at`, `updated_at`) VALUES ('18', 'free_courses_allowed', '1', 'tinyint(1)', 'courses', 'السماح بالدورات المجانية', 'السماح بإنشاء دورات مجانية', '0', '2025-08-25 12:56:25', '2025-08-25 12:56:25');
INSERT INTO `settings` (`id`, `key`, `value`, `type`, `group`, `label`, `description`, `is_public`, `created_at`, `updated_at`) VALUES ('19', 'course_certificate_enabled', '1', 'tinyint(1)', 'courses', 'تفعيل شهادات الدورات', 'تفعيل إصدار شهادات إتمام الدورات', '0', '2025-08-25 12:56:25', '2025-08-25 12:56:25');
...
INSERT INTO `settings` (`id`, `key`, `value`, `type`, `group`, `label`, `description`, `is_public`, `created_at`, `updated_at`) VALUES ('22', 'stripe_enabled', '1', 'tinyint(1)', 'payment', 'تفعيل Stripe', 'تفعيل بوابة الدفع Stripe', '0', '2025-08-25 12:56:25', '2025-08-25 12:56:25');
...
INSERT INTO `settings` (`id`, `key`, `value`, `type`, `group`, `label`, `description`, `is_public`, `created_at`, `updated_at`) VALUES ('25', 'paypal_enabled', '1', 'tinyint(1)', 'payment', 'تفعيل PayPal', 'تفعيل بوابة الدفع PayPal', '0', '2025-08-25 12:56:25', '2025-08-25 12:56:25');
...
INSERT INTO `settings` (`id`, `key`, `value`, `type`, `group`, `label`, `description`, `is_public`, `created_at`, `updated_at`) VALUES ('28', 'bank_transfer_enabled', '1', 'tinyint(1)', 'payment', 'تفعيل التحويل البنكي', 'تفعيل خيار التحويل البنكي', '0', '2025-08-25 12:56:25', '2025-08-25 12:56:25');
...
INSERT INTO `settings` (`id`, `key`, `value`, `type`, `group`, `label`, `description`, `is_public`, `created_at`, `updated_at`) VALUES ('32', 'welcome_email_enabled', '1', 'tinyint(1)', 'email', 'تفعيل بريد الترحيب', 'إرسال بريد ترحيب للمستخدمين الجدد', '0', '2025-08-25 12:56:25', '2025-08-25 12:56:25');
INSERT INTO `settings` (`id`, `key`, `value`, `type`, `group`, `label`, `description`, `is_public`, `created_at`, `updated_at`) VALUES ('33', 'course_completion_email', '1', 'tinyint(1)', 'email', 'بريد إكمال الدورة', 'إرسال بريد عند إكمال الدورة', '0', '2025-08-25 12:56:25', '2025-08-25 12:56:25');
INSERT INTO `settings` (`id`, `key`, `value`, `type`, `group`, `label`, `description`, `is_public`, `created_at`, `updated_at`) VALUES ('34', 'payment_confirmation_email', '1', 'tinyint(1)', 'email', 'بريد تأكيد الدفع', 'إرسال بريد تأكيد الدفع', '0', '2025-08-25 12:56:25', '2025-08-25 12:56:25');
INSERT INTO `settings` (`id`, `key`, `value`, `type`, `group`, `label`, `description`, `is_public`, `created_at`, `updated_at`) VALUES ('35', 'newsletter_enabled', '1', 'tinyint(1)', 'email', 'تفعيل النشرة الإخبارية', 'تفعيل إرسال النشرة الإخبارية', '0', '2025-08-25 12:56:25', '2025-08-25 12:56:25');
...
INSERT INTO `settings` (`id`, `key`, `value`, `type`, `group`, `label`, `description`, `is_public`, `created_at`, `updated_at`) VALUES ('55', 'maintenance_mode', '0', 'tinyint(1)', 'system', 'وضع الصيانة', 'تفعيل وضع الصيانة للموقع', '0', '2025-08-25 12:56:25', '2025-08-25 12:56:25');
...
INSERT INTO `settings` (`id`, `key`, `value`, `type`, `group`, `label`, `description`, `is_public`, `created_at`, `updated_at`) VALUES ('57', 'user_registration_enabled', '1', 'tinyint(1)', 'system', 'تفعيل التسجيل', 'السماح للمستخدمين الجدد بالتسجيل', '0', '2025-08-25 12:56:25', '2025-08-25 12:56:25');
INSERT INTO `settings` (`id`, `key`, `value`, `type`, `group`, `label`, `description`, `is_public`, `created_at`, `updated_at`) VALUES ('58', 'email_verification_required', '1', 'tinyint(1)', 'system', 'تأكيد البريد الإلكتروني', 'تطلب تأكيد البريد الإلكتروني', '0', '2025-08-25 12:56:25', '2025-08-25 12:56:25');
...
INSERT INTO `settings` (`id`, `key`, `value`, `type`, `group`, `label`, `description`, `is_public`, `created_at`, `updated_at`) VALUES ('63', 'password_require_special', '1', 'tinyint(1)', 'system', 'تطلب رموز خاصة', 'تطلب كلمة المرور رموز خاصة', '0', '2025-08-25 12:56:25', '2025-08-25 12:56:25');
INSERT INTO `settings` (`id`, `key`, `value`, `type`, `group`, `label`, `description`, `is_public`, `created_at`, `updated_at`) VALUES ('64', 'email_notifications_enabled', '1', 'tinyint(1)', 'notifications', 'تفعيل إشعارات البريد', 'تفعيل إرسال الإشعارات عبر البريد', '0', '2025-08-25 12:56:25', '2025-08-25 12:56:25');
INSERT INTO `settings` (`id`, `key`, `value`, `type`, `group`, `label`, `description`, `is_public`, `created_at`, `updated_at`) VALUES ('65', 'sms_notifications_enabled', '0', 'tinyint(1)', 'notifications', 'تفعيل إشعارات SMS', 'تفعيل إرسال الإشعارات عبر SMS', '0', '2025-08-25 12:56:25', '2025-08-25 12:56:25');
INSERT INTO `settings` (`id`, `key`, `value`, `type`, `group`, `label`, `description`, `is_public`, `created_at`, `updated_at`) VALUES ('66', 'push_notifications_enabled', '1', 'tinyint(1)', 'notifications', 'تفعيل الإشعارات الفورية', 'تفعيل الإشعارات الفورية في المتصفح', '0', '2025-08-25 12:56:25', '2025-08-25 12:56:25');
INSERT INTO `settings` (`id`, `key`, `value`, `type`, `group`, `label`, `description`, `is_public`, `created_at`, `updated_at`) VALUES ('67', 'new_course_notification', '1', 'tinyint(1)', 'notifications', 'إشعارات الدورات الجديدة', 'إرسال إشعارات عند إضافة دورات جديدة', '0', '2025-08-25 12:56:25', '2025-08-25 12:56:25');
INSERT INTO `settings` (`id`, `key`, `value`, `type`, `group`, `label`, `description`, `is_public`, `created_at`, `updated_at`) VALUES ('68', 'course_update_notification', '1', 'tinyint(1)', 'notifications', 'إشعارات تحديث الدورات', 'إرسال إشعارات عند تحديث الدورات', '0', '2025-08-25 12:56:25', '2025-08-25 12:56:25');
INSERT INTO `settings` (`id`, `key`, `value`, `type`, `group`, `label`, `description`, `is_public`, `created_at`, `updated_at`) VALUES ('69', 'payment_notification', '1', 'tinyint(1)', 'notifications', 'إشعارات المدفوعات', 'إرسال إشعارات عند إتمام المدفوعات', '0', '2025-08-25 12:56:25', '2025-08-25 12:56:25');

CREATE TABLE `quiz_questions` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `quiz_id` int(11) not null, `question_ar` varchar(255) not null, `question_en` varchar(255), `type` varchar(255) not null default 'multiple_choice', `options` longtext, `correct_answer` varchar(255), `explanation_ar` longtext, `explanation_en` longtext, `points` int(11) not null default '1', `sort_order` int(11) not null default '0', `is_active` tinyint(1) not null default '1', `created_at` timestamp, `updated_at` timestamp, foreign key(`quiz_id`) references `quizzes`(`id`) on delete cascade);
...
CREATE TABLE `quiz_attempts` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `quiz_id` int(11) not null, `user_id` int(11) not null, `attempt_number` int(11) not null default '1', `started_at` timestamp not null, `completed_at` timestamp, `score` int(11) not null default '0', `total_points` int(11) not null default '0', `percentage` numeric not null default '0', `is_passed` tinyint(1) not null default '0', `answers` longtext, `notes` longtext, `created_at` timestamp, `updated_at` timestamp, foreign key(`quiz_id`) references `quizzes`(`id`) on delete cascade, foreign key(`user_id`) references `users`(`id`) on delete cascade);
...
CREATE TABLE `contact_messages` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `name` varchar(255) not null, `email` varchar(255) not null, `phone` varchar(255), `subject` varchar(255) not null, `message` longtext not null, `status` varchar(255) not null default 'new', `admin_notes` longtext, `read_at` timestamp, `replied_at` timestamp, `created_at` timestamp, `updated_at` timestamp);
...
CREATE TABLE `user_settings` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `user_id` int(11) not null, `key` varchar(255) not null, `value` longtext not null, `created_at` timestamp, `updated_at` timestamp, foreign key(`user_id`) references `users`(`id`) on delete cascade);
...
CREATE TABLE `lesson_completions` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `enrollment_id` int(11) not null, `lesson_id` int(11) not null, `user_id` int(11) not null, `completed_at` timestamp not null, `time_spent_minutes` int(11), `progress_percentage` numeric not null default '0', `quiz_results` longtext, `created_at` timestamp, `updated_at` timestamp, foreign key(`enrollment_id`) references `enrollments`(`id`) on delete cascade, foreign key(`lesson_id`) references `lessons`(`id`) on delete cascade, foreign key(`user_id`) references `users`(`id`) on delete cascade);
...
CREATE TABLE `course_resources` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `course_id` int(11) not null, `lesson_id` int(11), `title_ar` varchar(255) not null, `title_en` varchar(255), `description_ar` longtext, `description_en` longtext, `type` varchar(255) not null default 'document', `file_path` varchar(255), `file_name` varchar(255), `file_size` varchar(255), `external_url` varchar(255), `is_free` tinyint(1) not null default '1', `is_published` tinyint(1) not null default '1', `sort_order` int(11) not null default '0', `download_count` int(11) not null default '0', `created_at` timestamp, `updated_at` timestamp, foreign key(`course_id`) references `courses`(`id`) on delete cascade, foreign key(`lesson_id`) references `lessons`(`id`) on delete cascade);
...
CREATE TABLE `messages` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `sender_id` int(11) not null, `receiver_id` int(11) not null, `course_id` int(11), `subject` varchar(255), `content` longtext not null, `type` varchar(255) not null default 'general', `priority` varchar(255) not null default 'medium', `status` varchar(255) not null default 'unread', `parent_id` int(11), `read_at` timestamp, `created_at` timestamp, `updated_at` timestamp, foreign key(`sender_id`) references `users`(`id`) on delete cascade, foreign key(`receiver_id`) references `users`(`id`) on delete cascade, foreign key(`course_id`) references `courses`(`id`) on delete cascade, foreign key(`parent_id`) references `messages`(`id`) on delete cascade);
