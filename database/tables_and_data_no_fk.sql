...
CREATE TABLE `certificates` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `user_id` int(11) not null, `course_id` int(11) not null, `enrollment_id` int(11) not null, `certificate_number` varchar(255) not null, `issued_at` timestamp, `pdf_path` varchar(255), `verification_code` varchar(255) not null, `is_verified` tinyint(1) not null default '0', `notes` longtext, `created_at` timestamp, `updated_at` timestamp);
...
CREATE TABLE `notifications` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `title` varchar(255) not null, `message` longtext not null, `type` varchar(255) not null default 'info', `user_id` int(11), `read_at` timestamp, `data` longtext, `created_at` timestamp, `updated_at` timestamp);
...
CREATE TABLE `model_has_permissions` (`permission_id` int(11) not null, `model_type` varchar(255) not null, `model_id` int(11) not null, primary key (`permission_id`, `model_id`, `model_type`));


CREATE TABLE `model_has_roles` (`role_id` int(11) not null, `model_type` varchar(255) not null, `model_id` int(11) not null, primary key (`role_id`, `model_id`, `model_type`));
...
CREATE TABLE `role_has_permissions` (`permission_id` int(11) not null, `role_id` int(11) not null, primary key (`permission_id`, `role_id`));
...
CREATE TABLE `quiz_attempts` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `quiz_id` int(11) not null, `user_id` int(11) not null, `attempt_number` int(11) not null default '1', `started_at` timestamp not null, `completed_at` timestamp, `score` int(11) not null default '0', `total_points` int(11) not null default '0', `percentage` numeric not null default '0', `is_passed` tinyint(1) not null default '0', `answers` longtext, `notes` longtext, `created_at` timestamp, `updated_at` timestamp);
...
CREATE TABLE `user_settings` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `user_id` int(11) not null, `key` varchar(255) not null, `value` longtext not null, `created_at` timestamp, `updated_at` timestamp);
...
CREATE TABLE `lesson_completions` (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `enrollment_id` int(11) not null, `lesson_id` int(11) not null, `user_id` int(11) not null, `completed_at` timestamp not null, `time_spent_minutes` int(11), `progress_percentage` numeric not null default '0', `quiz_results` longtext, `created_at` timestamp, `updated_at` timestamp);
